...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        item.setFont(font)
        item.setBackground(QtGui.QColor(255, 170, 0))
        self.tabla_productos.setHorizontalHeaderItem(8, item)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.tabla_buscar.setColumnCount(8)
        ...
        item.setFont(font)
        item.setBackground(QtGui.QColor(255, 170, 0))
        self.tabla_buscar.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        item.setFont(font)
        item.setBackground(QtGui.QColor(255, 170, 0))
        self.tabla_buscar.setHorizontalHeaderItem(8, item)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.cantidadadA = QtWidgets.QLineEdit(self.layoutWidget)
        self.cantidadadA.setObjectName("cantidadadA")
        self.verticalLayout.addWidget(self.cantidadadA)
        ...
        self.marcaA = QtWidgets.QLineEdit(self.layoutWidget)
        self.marcaA.setObjectName("marcaA")
        self.verticalLayout.addWidget(self.marcaA)
        self.descuentoA = QtWidgets.QLineEdit(self.layoutWidget)
        self.descuentoA.setObjectName("descuentoA")
        self.verticalLayout.addWidget(self.descuentoA)
        self.imagenA = QtWidgets.QLineEdit(self.layoutWidget)
        self.imagenA.setObjectName("imagenA")
        self.verticalLayout.addWidget(self.imagenA)
        self.descripcionA = QtWidgets.QLineEdit(self.layoutWidget)
        self.descripcionA.setObjectName("descripcionA")
        self.verticalLayout.addWidget(self.descripcionA)
        self.categoriaA = QtWidgets.QLineEdit(self.layoutWidget)
        self.categoriaA.setObjectName("categoriaA")
        self.verticalLayout.addWidget(self.categoriaA)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.marca_actualizar = QtWidgets.QLineEdit(self.layoutWidget1)
        self.marca_actualizar.setObjectName("marca_actualizar")
        self.verticalLayout_3.addWidget(self.marca_actualizar)

        self.descuento_actualizar = QtWidgets.QLineEdit(self.layoutWidget1)
        self.descuento_actualizar.setObjectName("descuento_actualizar")
        self.verticalLayout_3.addWidget(self.descuento_actualizar)

        self.urlImagen_actualizar = QtWidgets.QLineEdit(self.layoutWidget1)
        self.urlImagen_actualizar.setObjectName("urlImagen_actualizar")
        self.verticalLayout_3.addWidget(self.urlImagen_actualizar)

        self.descripcion_actualizar = QtWidgets.QLineEdit(self.layoutWidget1)
        self.descripcion_actualizar.setObjectName("descripcion_actualizar")
        self.verticalLayout_3.addWidget(self.descripcion_actualizar)

        self.categoria_actualizar = QtWidgets.QLineEdit(self.layoutWidget1)
        self.categoria_actualizar.setObjectName("categoria_actualizar")
        self.verticalLayout_3.addWidget(self.categoria_actualizar)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.pantalla.setCurrentIndex(8)
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Stock", None))
        ...
        item.setText(_translate("Form", "Precio", None))
        item = self.tabla_buscar.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Marca", None))
        item = self.tabla_buscar.horizontalHeaderItem(5)
        item.setText(_translate("Form", "Descuento", None))
        item = self.tabla_buscar.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Imagen", None))
        item = self.tabla_buscar.horizontalHeaderItem(7)
        item.setText(_translate("Form", "Descripcion", None))
        #item = self.tabla_buscar.horizontalHeaderItem(8)
        #item.setText(_translate("Form", "Categoria", None))
        ...
        self.label_3.setText(_translate("Form", "STOCK:"))
        ...
        self.label_15.setText(_translate("Form", "URLIMAGEN: "))
        self.label_16.setText(_translate("Form", "DESCRIPCION: "))
        self.label_17.setText(_translate("Form", "CATEGORIA: "))
        ...
        self.label_11.setText(_translate("Form", "MARCA: "))
        self.label_18.setText(_translate("Form", "DESCUENTO:"))
        self.label_19.setText(_translate("Form", "URLIMAGEN: "))
        self.label_20.setText(_translate("Form", "DESCRIPCION: "))
        self.label_21.setText(_translate("Form", "CATEGORIA: "))
        ...
        item.setText(_translate("Form", "urlImagen"))
